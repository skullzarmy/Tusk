...
function showDeprecationWarning() {
    if (!deprecationWarningShown) {
        ...
        console.warn("The 'tusk-mastodon' package is deprecated and no longer maintained.");
        console.warn("Please migrate to the 'masto' package: https://www.npmjs.com/package/masto");
        console.warn("This warning will only be shown once.\n");
 ...
 * @deprecated This package is deprecated. Please use 'masto' instead: https://www.npmjs.com/package/masto
 */
class Tusk {
    /**
